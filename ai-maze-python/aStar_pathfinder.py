...
if __name__ == "__main__":
  ...
  parser.add_argument("--display", help="Display generating process 0: False, 1:True", default=0, type=int)
  ...
  print(f"--- nodes explored: {len(seen)} ---")
  exit(0)